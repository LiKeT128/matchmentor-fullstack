    ...
    return (
        <div className="min-h-screen bg-gray-900 pt-24 pb-12 px-4 print:pt-4">
            <div className="max-w-6xl mx-auto">
                ...
                {!match.selected_hero_name || match.selected_hero_name === 'pending' ? (
                    <div className="bg-gray-800/50 border border-teal-500/20 rounded-[2.5rem] p-12 text-center mb-10 shadow-2xl">
                        ...
                        <h2 className="text-3xl font-black text-white uppercase italic tracking-tighter mb-4">Select Your Hero</h2>
                        <p className="text-gray-400 max-w-md mx-auto mb-8 font-medium leading-relaxed">
                            We've processed the match data. Now select the hero you played to generate your personalized Elite Scouting Report and deep tactical analysis.
                        </p>

                        <div className="bg-gray-900/50 rounded-3xl p-8 border border-white/5 inline-block w-full max-w-4xl">
                                ...
                                {(match.parsed_data?.heroes || []).map((h: any) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="transition-all rounded-lg overflow-hidden border-2 border-transparent opacity-60 hover:opacity-100 hover:border-teal-500 hover:scale-110"
                                        >
                                            <img src={`https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota_react/heroes/${hShort}.png`} className="w-full grayscale hover:grayscale-0 transition-all" />
                                        </button>
                                    );
                                })}
                            </div>
                            {selecting && (
                                <div className="mt-8 flex items-center justify-center gap-3 bg-teal-500/10 py-4 rounded-2xl border border-teal-500/20">
                                    <LoadingSpinner size="sm" />
                                    <span className="text-teal-400 font-bold uppercase tracking-widest text-xs">Generating Strategic Intelligence...</span>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <>
                        ...
                        <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/50 rounded-[2.5rem] p-8 mb-10 shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-700">
